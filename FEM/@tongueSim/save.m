...
if light
 	TSObj.saveVars(TSObj.file_mat, 'sujet', TSObj.speaker, 'U_fin', U(end,:),...
 		...
 		'X0', TSObj.X0, 'Y0', TSObj.Y0, 'U_dents_inf_fin', TSObj.UU.lowerteeth(end,:),...
 		...
 		'U_tongue_lar_mri_fin', TSObj.UU.tongue_lar_mri(end,:), 'X0_seq_fin', X0_seq_fin, 
     ...
     command=['save ' TSObj.file_mat '_light'  list_data_sauv];
     eval(command)
 else
