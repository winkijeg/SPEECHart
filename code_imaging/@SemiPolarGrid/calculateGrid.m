function obj = calculateGrid( obj, struc )
...
ptAlvRidge = struc.xyAlvRidge;
p_Palate = struc.xyPalate;
p_PharH = struc.xyPharH;
p_PharL = struc.xyPharL;
p_Lx = struc.xyLx;
p_LipU = struc.xyLipU;
p_LipL = struc.xyLipL;
ptCircleMidpoint = struc.xyCircleMidpoint;
